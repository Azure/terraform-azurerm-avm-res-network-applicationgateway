...
# sudo mkdir -p /var/www/html/LicenseRenewal
# echo "Images: " $(hostname) | sudo tee /var/www/html/LicenseRenewal/test.html
# sudo mkdir -p /var/www/html/VehicleRegistration
# echo "Video: " $(hostname) | sudo tee /var/www/html/VehicleRegistration/test.html
# CUSTOM_DATA
# }
